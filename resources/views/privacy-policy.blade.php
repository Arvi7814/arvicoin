...
<ul>
    ...
    <li>
        <p>
            <strong>Application</strong> refers to ARVI Coin, the software
    ...
    <li>
        <p>
            ...
            this Agreement) refers to ARVI Coin.
        </p>
    </li>
    <li>
...
<ul>
    <li>
        <p>By email: djumaniyozovsuxrobbek@gmail.com</p>
    </li>
    <li>
        <p>By phone number: +998913770623</p>
    </li>
</ul>
